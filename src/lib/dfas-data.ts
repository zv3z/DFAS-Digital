...
export const MODULES: ModuleDef[] = [
  ...
  { id: "mod-11", code: "MOD-11", slug: "memory",   icon: "🧠", nameAr: "الطب الشرعي للذاكرة",      descAr: "تحليل مقالب الذاكرة وإخراج Volatility3 لكشف Shellcode والـ RATs والـ Process Injection", inputType: "text", placeholder: "الصق إخراج Volatility (pslist, malfind, netscan) أو strings من memory dump..." },
  { id: "mod-12", code: "MOD-12", slug: "disk",     icon: "💽", nameAr: "محلل صور الأقراص",         descAr: "تحليل صور الأقراص (ISO/IMG/E01) وإخراج Sleuth Kit لكشف الملفات المحذوفة والـ Timestomping", inputType: "file", placeholder: "ارفع ملف صورة قرص (ISO, IMG, DD, E01) أو الصق إخراج TSK (fls/mmls/fsstat)..." },
  { id: "mod-13", code: "MOD-13", slug: "pcap",     icon: "📡", nameAr: "محلل حركة الشبكة",        descAr: "تحليل مخرجات Tshark وملفات PCAP لكشف C2 Beacons وDNS Tunneling والحركات الجانبية", inputType: "text", placeholder: "الصق إخراج Tshark أو tcpdump أو سجلات حركة الشبكة..." },
  { id: "mod-14", code: "MOD-14", slug: "endpoint", icon: "🖥️", nameAr: "تلمترية نقاط النهاية",    descAr: "تحليل أحداث Sysmon وسجلات Windows وقطع أثر Velociraptor لكشف LOLBins والـ Persistence وسرقة بيانات الاعتماد", inputType: "text", placeholder: "الصق Sysmon events أو Windows Event logs أو Velociraptor VQL output..." },
];
