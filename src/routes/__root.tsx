  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass rounded-2xl p-10 text-center max-w-md">
        ...
        <Link
          to="/"
          className="inline-flex mt-6 px-5 py-2.5 rounded-lg bg-primary text-primary-foreground font-medium glow-cyan"
        >
          العودة للرئيسية
        </Link>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass rounded-2xl p-10 text-center max-w-md">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          حدث خطأ في النظام. يمكنك إعادة المحاولة.
        </p>
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a href="/" className="px-4 py-2 rounded-lg border border-border">
            الرئيسية
          </a>
        </div>
      </div>
